...
if (isset($_POST['login'])){
    ...
    if ($user){
        if (password_verify($_POST['password'],$user->password)){
            ...
            $_SESSION['avatar'] = $user->avatar != null?"uploads/avatars/".$user->avatar:"images/profile-2.png";
                ...
                <div class="card shadow-none border-0 ms-auto me-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form method="post">
                            ...
                            if (isset($_GET['action']) && $_GET['action'] == "just_registered") {
                                echo '<badge class="badge badge-success w-100">You have successfully registered, <br>now try to sign in into your account</badge>';
                            }
                            ?>
